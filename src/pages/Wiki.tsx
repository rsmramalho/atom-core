    ...
    >
      ...
      <div className="flex flex-1">
        ...
        <main ref={mainRef} className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 py-6 pb-20">
            ...
            <AccordionItem value="parsing" className="border border-border/50 rounded-lg px-4 bg-card/30">
              ...
              <AccordionContent className="text-sm text-muted-foreground space-y-3">
                ...
                <TokenTable tokens={[
                  ...
                  { token: "~meio_dia", desc: "Ritual slot: meio-dia (Zênite)" },
                  { token: "~noite", desc: "Ritual slot: noite (Crepúsculo)" },
                  { token: "tipo:habit", desc: "Cria como hábito" },
                  { token: "tipo:note", desc: "Cria como nota" },
                  { token: "tipo:task", desc: "Cria como tarefa" },
                ]} />
                <p className="font-medium text-foreground">Exemplos combinados:</p>
                <div className="space-y-2">
                  <p><CodeToken>Estudar React @amanha #estudo ~manha tipo:task</CodeToken></p>
                  <p className="text-xs">→ Task "Estudar React", due amanhã, tag #estudo, slot manhã</p>
                  <p><CodeToken>Reunião semanal @segunda #mod_work tipo:task</CodeToken></p>
                  <p className="text-xs">→ Task "Reunião semanal", próxima segunda, módulo work</p>
                  <p><CodeToken>Meditar 10min ~noite tipo:habit</CodeToken></p>
                  <p className="text-xs">→ Hábito "Meditar 10min", slot noite (Crepúsculo)</p>
                  <p><CodeToken>Lançar MVP v1 #milestone #mod_work</CodeToken></p>
                  <p className="text-xs">→ Task com tag milestone (peso 3x), módulo work</p>
                </div>
              </AccordionContent>
            </AccordionItem>
          ...
          {/* ====== GLOSSÁRIO ====== */}
          <SectionTitle id="glossario" icon={BookText}>Glossário de Termos</SectionTitle>
          ...
          <GlossaryTable terms={[
            ...
            { term: "Token", desc: "Marcador no texto que o Parsing Engine interpreta (ex: @hoje, #tag, ~manha, tipo:task)." },
          ...
          {/* ====== DIAGRAMA ====== */}
          <SectionTitle id="diagrama" icon={Layers}>Arquitetura Visual</SectionTitle>
         ...
         (today)       (month/week)  (slot check-in)`}
          ...
          <div className="mt-12 pt-6 border-t border-border/50 text-center space-y-2">
            ...
            <p className="text-[10px] text-muted-foreground/60">
              v4.0.0-alpha.17 · Última atualização: Dezembro 2025
            </p>
          </div>
        </main>
      </div>
