        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">Single Table</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Uma tabela <code className="text-xs bg-muted px-1 py-0.5 rounded">items</code> governa tudo. Schema minimalista, queries simples, manutenção zero.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">Fork-Friendly</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Documentação completa, arquitetura modular. Faça fork e construa sua própria versão em minutos.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">Stack Moderna</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                React + Vite + TypeScript + Supabase + Tailwind. Zero configuração, DX primeiro.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                MIT License. Contribua, aprenda, adapte. Comunidade aberta e PRs bem-vindos.
              </p>
            </motion.div>
          </div>
        </div>
